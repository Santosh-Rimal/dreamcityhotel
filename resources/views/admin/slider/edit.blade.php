                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('slogan') is-invalid @enderror" id=""
                                    type="text" value="{{ old('slogan', $slider->slogan) }}" name="slogan"
                                    placeholder="">
                                @error('slogan')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" id=""
                                    type="text" name="title" value="{{ old('title', $slider->title) }}" placeholder="">
                                @error('title')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('order') is-invalid @enderror" id=""
                                    type="text" name="order" value="{{ old('order', $slider->order) }}" placeholder="">
                                @error('order')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if ($slider->image)
                                        <img class="mt-2 old-image"
                                            src="{{ asset('admin/assets/img/slider/' . $slider->image) }}" width="100">
                                    @endif
                                    @error('image')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
