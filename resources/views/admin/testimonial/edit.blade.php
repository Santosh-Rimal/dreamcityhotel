    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Testimonials "{{ $testimonial->name }}"</h5>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id=""
                                    type="text" value="{{ old('name', $testimonial->name) }}" name="name"
                                    placeholder="">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('order') is-invalid @enderror" id=""
                                    type="text" name="order" value="{{ old('order', $testimonial->order) }}"
                                    placeholder="">
                                @error('order')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" id="" name="short_description"
                                    rows="4" placeholder="">{{ old('short_description', $testimonial->short_description) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if ($testimonial->image)
                                        <img class="mt-2 old-image"
                                            src="{{ asset('admin/assets/img/testimonial/' . $testimonial->image) }}"
                                            width="100">
                                    @endif
                                    @error('image')
                                        <div class="invalid-feedback" style="display: block;">
